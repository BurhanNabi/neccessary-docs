# SSH_ENV=/home/bnabi/.ssh/environment
...
PS1="\[$bldblu\]\u@\h \[$bldylw\]\[$bldylw\]\W\[\033[m\]\[$bldwht\]\$(__git_ps1) \[$bldblu\]\$ \[$txtrst\]"


source /home/bnabi/.rvm/scripts/rvm
export PATH=${PATH}:$HOME/bin

# Alias for compiling C++
alias c++11='g++ -g -std=c++11'
...
alias say=espeak
alias konaaya='say "aagaya choohthiya" '

# Alias for killing Telegram
alias kt='killall Telegram'


###-tns-completion-start-###
# if [ -f /home/bnabi/.tnsrc ]; then 
#     source /home/bnabi/.tnsrc 
# fi
###-tns-completion-end-###
